...
('{"X":15,"Y":37}', 5000, 'Крутая почти новая киа рио', 1, 1, 1, 1, 'static/images/defaultCarImages/'),
('{"X":40,"Y":70}', 7000, 'Лучшая лада гранта', 2, 2, 3, 1, 'static/images/defaultCarImages/'),
('{"X":80,"Y":90}', 15000, 'Крутой новый мерс для крутых молодежных ребят', 2, 3, 1, 1, 'static/images/defaultCarImages/');
